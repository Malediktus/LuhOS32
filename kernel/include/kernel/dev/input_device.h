#ifndef __KERNEL_INPUT_DEVICE_H
#define __KERNEL_INPUT_DEVICE_H
...
{
    INPUT_EVENT_NONE = 0,
    INPUT_EVENT_KEY_PRESSED = 1,
    INPUT_EVENT_KEY_RELEASED = 2,
    INPUT_EVENT_KEY = 3,
...
{
    uint32_t (*get_event)(struct input_device *, input_device_event_t *);
    void *private_data;
} input_device_t;
